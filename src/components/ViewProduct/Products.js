...
function Products(props) {
	...
	return (
		...
		>
			...
			{products
				.filter((product) => product.stall === props.stall)
				.map((filteredProduct) => (
					<>
						<div
							className='eachProduct'
							onClick={() => selectedProduct(filteredProduct._id)}
						>
							<div className='product-img'>
								{filteredProduct.image[0] && (
									<img
										src={filteredProduct.image[0]}
